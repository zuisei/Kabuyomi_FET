...
- Clean local-only generated artifacts before packaging:
  ...
  - `test-results/`
  - `tmp/`
  - local scratch files such as `timpo.md` / `timtim.md`, if they are not intentionally part of the sale record
...
- `docs/release/PROMPT_V2_MAIN_DEPLOY_QUALITY_HARDENING_REPORT.md`
