...
- Company UI polish remains included. Evidence: `docs/archive/v1/V1_0_2_COMPANY_UI_POLISH_RESTORED_REPORT.md` says Company UI polish is restored into the v1.0.2 release candidate, and `docs/archive/v1/V1_0_2_TESTFLIGHT_SMOKE_EVIDENCE_PACKET.md` says Company UI polish is included.
...
24. Fill `docs/archive/v1/V1_0_2_TESTFLIGHT_SMOKE_EVIDENCE_PACKET.md` and/or `docs/admob/rewarded_admob_credits_runbook.md` evidence rows with sanitized summaries.
...
| Evidence packet has rows to fill | READY_FOR_HUMAN_SMOKE | `docs/archive/v1/V1_0_2_TESTFLIGHT_SMOKE_EVIDENCE_PACKET.md` has AdMob rows and an evidence table. |
