...
2. current code under `ios/`, `workers/`, and `sec-fetcher/`
3. `specs/kabuyomi_spec_v3.md`
4. `specs/kabuyomi_positioning_spec_v1.md`
5. `specs/kabuyomi_engagement_spec_v1.md`
6. `specs/kabuyomi_conversational_ui_spec_v1.md`
7. `specs/kabuyomi_as_built_spec.md`
